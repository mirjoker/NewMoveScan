...
| id | Detector | Define |
|-|-|-|
|1|Infinite_Loop|Infinite loop refers to a situation in a contract where a loop construct exists, but the loop body fails to satisfy the termination condition, resulting in an infinite repetition of the loop.|
